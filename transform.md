...
#> # A tibble: 10 x 6
#>   month   day carrier flight dep_delay dep_delay_rank
#>   <int> <int> <chr>    <int>     <dbl>          <int>
#> 1     1     9 HA          51      1301              1
#> 2     6    15 MQ        3535      1137              2
#> 3     1    10 MQ        3695      1126              3
#> 4     9    20 AA         177      1014              4
#> 5     7    22 MQ        3075      1005              5
#> 6     4    10 DL        2391       960              6
#> # … with 4 more rows
```
...
All trigonometric functions are all described in a single page, [Trig](https://www.rdocumentation.org/packages/base/topics/Trig)
help page.
...
<img src="transform_files/figure-html/unnamed-chunk-87-1.png" width="70%" style="display: block; margin: auto;" />
...
<img src="transform_files/figure-html/unnamed-chunk-99-1.png" width="70%" style="display: block; margin: auto;" />
...
<img src="transform_files/figure-html/unnamed-chunk-103-1.png" width="70%" style="display: block; margin: auto;" />
...
<img src="transform_files/figure-html/unnamed-chunk-105-1.png" width="70%" style="display: block; margin: auto;" />
